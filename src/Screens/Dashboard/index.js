...
export const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    document.title = 'Food Stadium Admin | Dashboard';
  }, []);
                    ...
                    <div className="statsCard">
                      <div className="statsContent">
                        <div className="statsData">
                          ...
                          <h3 className="statsNumber">7</h3>
                          <p className="statsText">Total Menu</p>
                        </div>
                      </div>
                      <div className="statsChange">
                        <p>
                    ...
                    <div className="statsCard">
                      <div className="statsContent">
                        <div className="statsData">
                          ...
                          <h3 className="statsNumber">8</h3>
                          <p className="statsText">Total Dietary</p>
                        </div>
                      </div>
                      <div className="statsChange">
                        <p>
